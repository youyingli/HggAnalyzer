...
from HggAnalyzer.Dumper.vh_dumper import zhleptonic_proc_func

indir  = "/wk_cms2/youying/public/vh_ntuples/whleptonic_v2"
outdir = "/wk_cms2/youying/VHAnalysis/vhmet_an/CMSSW_10_2_20/src/pre_UL_test_v2/fff"
...
if is2016:
    ...
    argu_list.append([indir + "/2016/output_WminusH_HToGG_WToAll_M125_13TeV_powheg_pythia8.root"                           , "wh_125"         , 35.92, outdir + "/2016", ""])
    argu_list.append([indir + "/2016/output_WplusH_HToGG_WToAll_M125_13TeV_powheg_pythia8.root"                            , "wh_125"         , 35.92, outdir + "/2016", ""])
    argu_list.append([indir + "/2016/output_WHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "wh_125"         , 35.92, outdir + "/2016", ""])
    argu_list.append([indir + "/2016/output_ZH_HToGG_ZToAll_M125_13TeV_powheg_pythia8.root"                                , "zh_125"         , 35.92, outdir + "/2016", ""])
    argu_list.append([indir + "/2016/output_ZHToGG_M123_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_123"         , 35.92, outdir + "/2016", ""])
    argu_list.append([indir + "/2016/output_ZHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_125"         , 35.92, outdir + "/2016", ""])
    argu_list.append([indir + "/2016/output_ZHToGG_M126_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_126"         , 35.92, outdir + "/2016", ""])
    argu_list.append([indir + "/2016/output_ZHToGG_M127_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_127"         , 35.92, outdir + "/2016", ""])
...
if is2017:
    ...
    argu_list.append([indir + "/2017/output_WHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "wh_125"         , 41.53, outdir + "/2017", ""])
    argu_list.append([indir + "/2017/output_WminusH_HToGG_WToAll_M125_13TeV_powheg_pythia8.root"                           , "wh_125"         , 41.53, outdir + "/2017", ""])
    argu_list.append([indir + "/2017/output_ZHToGG_M123_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_123"         , 41.53, outdir + "/2017", ""])
    ...
    argu_list.append([indir + "/2017/output_ZHToGG_M127_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_127"         , 41.53, outdir + "/2017", ""])
...
if is2018:
    ...
    argu_list.append([indir + "/2018/output_WHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "wh_125"         , 59.69, outdir + "/2018", ""])
    argu_list.append([indir + "/2018/output_WminusH_HToGG_WToAll_M125_TuneCP5_13TeV-powheg-pythia8.root"                   , "wh_125"         , 59.69, outdir + "/2018", ""])
    argu_list.append([indir + "/2018/output_WplusH_HToGG_WToAll_M125_13TeV_powheg_pythia8.root"                            , "wh_125"         , 59.69, outdir + "/2018", ""])
    argu_list.append([indir + "/2018/output_ZHToGG_M123_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_123"         , 59.69, outdir + "/2018", ""])
    argu_list.append([indir + "/2018/output_ZHToGG_M124_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_124"         , 59.69, outdir + "/2018", ""])
    argu_list.append([indir + "/2018/output_ZHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_125"         , 59.69, outdir + "/2018", ""])
    argu_list.append([indir + "/2018/output_ZHToGG_M126_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_126"         , 59.69, outdir + "/2018", ""])
    argu_list.append([indir + "/2018/output_ZHToGG_M127_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_127"         , 59.69, outdir + "/2018", ""])
...
parallel_process( zhleptonic_proc_func, argu_list )
