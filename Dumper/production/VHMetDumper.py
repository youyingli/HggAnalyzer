...
from HggAnalyzer.Dumper.vh_dumper import vhmet_proc_func

indir  = "/wk_cms2/youying/public/vh_ntuples/vhmet"
outdir = "/wk_cms2/youying/VHAnalysis/vhmet_an/CMSSW_10_2_20/src/pre_UL_test_v2/ffff"
...
if is2016:
    ...
    argu_list.append([indir + "/2016/output_DoubleEG.root"                                                                 , "Data"           , 1.0,   outdir + "/2016", "", True])
    ...
    argu_list.append([indir + "/2016/output_ZH_HToGG_ZToAll_M125_13TeV_powheg_pythia8.root"                                , "zh_125"         , 35.92, outdir + "/2016", "zh_dilep"])
    argu_list.append([indir + "/2016/output_ZHToGG_M123_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_123"         , 35.92, outdir + "/2016", "zh_dilep"])
    argu_list.append([indir + "/2016/output_ZHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_125"         , 35.92, outdir + "/2016", "zh_dilep"])
    argu_list.append([indir + "/2016/output_ZHToGG_M126_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_126"         , 35.92, outdir + "/2016", "zh_dilep"])
    argu_list.append([indir + "/2016/output_ZHToGG_M127_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_127"         , 35.92, outdir + "/2016", "zh_dilep"])

    argu_list.append([indir + "/2016/output_ZH_HToGG_ZToAll_M125_13TeV_powheg_pythia8.root"                                , "zh_125"         , 35.92, outdir + "/2016", "zh_met"])
    argu_list.append([indir + "/2016/output_ZHToGG_M123_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_123"         , 35.92, outdir + "/2016", "zh_met"])
    argu_list.append([indir + "/2016/output_ZHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_125"         , 35.92, outdir + "/2016", "zh_met"])
    argu_list.append([indir + "/2016/output_ZHToGG_M126_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_126"         , 35.92, outdir + "/2016", "zh_met"])
    argu_list.append([indir + "/2016/output_ZHToGG_M127_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_127"         , 35.92, outdir + "/2016", "zh_met"])

    argu_list.append([indir + "/2016/output_ZH_HToGG_ZToAll_M125_13TeV_powheg_pythia8.root"                                , "zh_125"         , 35.92, outdir + "/2016", "zh_had"])
    argu_list.append([indir + "/2016/output_ZHToGG_M123_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_123"         , 35.92, outdir + "/2016", "zh_had"])
    argu_list.append([indir + "/2016/output_ZHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_125"         , 35.92, outdir + "/2016", "zh_had"])
    argu_list.append([indir + "/2016/output_ZHToGG_M126_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_126"         , 35.92, outdir + "/2016", "zh_had"])
    argu_list.append([indir + "/2016/output_ZHToGG_M127_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_127"         , 35.92, outdir + "/2016", "zh_had"])
...
if is2017:
    ...
    argu_list.append([indir + "/2017/output_DoubleEG.root"                                                                 , "Data"           ,   1.0, outdir + "/2017", "", True])
    ...
    argu_list.append([indir + "/2017/output_ZHToGG_M123_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_123"         , 41.53, outdir + "/2017", "zh_dilep"])
    argu_list.append([indir + "/2017/output_ZHToGG_M124_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_124"         , 41.53, outdir + "/2017", "zh_dilep"])
    argu_list.append([indir + "/2017/output_ZHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_125"         , 41.53, outdir + "/2017", "zh_dilep"])
    argu_list.append([indir + "/2017/output_ZHToGG_M127_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_127"         , 41.53, outdir + "/2017", "zh_dilep"])
    argu_list.append([indir + "/2017/output_ZHToGG_M123_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_123"         , 41.53, outdir + "/2017", "zh_met"])
    argu_list.append([indir + "/2017/output_ZHToGG_M124_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_124"         , 41.53, outdir + "/2017", "zh_met"])
    argu_list.append([indir + "/2017/output_ZHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_125"         , 41.53, outdir + "/2017", "zh_met"])
    argu_list.append([indir + "/2017/output_ZHToGG_M127_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_127"         , 41.53, outdir + "/2017", "zh_met"])
    argu_list.append([indir + "/2017/output_ZHToGG_M123_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_123"         , 41.53, outdir + "/2017", "zh_had"])
    argu_list.append([indir + "/2017/output_ZHToGG_M124_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_124"         , 41.53, outdir + "/2017", "zh_had"])
    argu_list.append([indir + "/2017/output_ZHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_125"         , 41.53, outdir + "/2017", "zh_had"])
    argu_list.append([indir + "/2017/output_ZHToGG_M127_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_127"         , 41.53, outdir + "/2017", "zh_had"])
...
if is2018:
    ...
    argu_list.append([indir + "/2018/output_EGamma.root"                                                                   , "Data"           ,   1.0, outdir + "/2018", "", True])
    ...
    argu_list.append([indir + "/2018/output_ZHToGG_M123_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_123"         , 59.69, outdir + "/2018", "zh_dilep"])
    argu_list.append([indir + "/2018/output_ZHToGG_M124_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_124"         , 59.69, outdir + "/2018", "zh_dilep"])
    argu_list.append([indir + "/2018/output_ZHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_125"         , 59.69, outdir + "/2018", "zh_dilep"])
    argu_list.append([indir + "/2018/output_ZHToGG_M126_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_126"         , 59.69, outdir + "/2018", "zh_dilep"])
    argu_list.append([indir + "/2018/output_ZHToGG_M127_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_127"         , 59.69, outdir + "/2018", "zh_dilep"])
    argu_list.append([indir + "/2018/output_ZH_HToGG_ZToAll_M120_TuneCP5_13TeV-powheg-pythia8.root"                        , "zh_120"         , 59.69, outdir + "/2018", "zh_dilep"])
    argu_list.append([indir + "/2018/output_ZH_HToGG_ZToAll_M130_TuneCP5_13TeV-powheg-pythia8.root"                        , "zh_130"         , 59.69, outdir + "/2018", "zh_dilep"])
    argu_list.append([indir + "/2018/output_ZHToGG_M123_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_123"         , 59.69, outdir + "/2018", "zh_met"])
    argu_list.append([indir + "/2018/output_ZHToGG_M124_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_124"         , 59.69, outdir + "/2018", "zh_met"])
    argu_list.append([indir + "/2018/output_ZHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_125"         , 59.69, outdir + "/2018", "zh_met"])
    argu_list.append([indir + "/2018/output_ZHToGG_M126_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_126"         , 59.69, outdir + "/2018", "zh_met"])
    argu_list.append([indir + "/2018/output_ZHToGG_M127_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_127"         , 59.69, outdir + "/2018", "zh_met"])
    argu_list.append([indir + "/2018/output_ZH_HToGG_ZToAll_M120_TuneCP5_13TeV-powheg-pythia8.root"                        , "zh_120"         , 59.69, outdir + "/2018", "zh_met"])
    argu_list.append([indir + "/2018/output_ZH_HToGG_ZToAll_M130_TuneCP5_13TeV-powheg-pythia8.root"                        , "zh_130"         , 59.69, outdir + "/2018", "zh_met"])
    argu_list.append([indir + "/2018/output_ZHToGG_M123_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_123"         , 59.69, outdir + "/2018", "zh_had"])
    argu_list.append([indir + "/2018/output_ZHToGG_M124_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_124"         , 59.69, outdir + "/2018", "zh_had"])
    argu_list.append([indir + "/2018/output_ZHToGG_M125_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_125"         , 59.69, outdir + "/2018", "zh_had"])
    argu_list.append([indir + "/2018/output_ZHToGG_M126_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_126"         , 59.69, outdir + "/2018", "zh_had"])
    argu_list.append([indir + "/2018/output_ZHToGG_M127_13TeV_amcatnloFXFX_madspin_pythia8.root"                           , "zh_127"         , 59.69, outdir + "/2018", "zh_had"])
    argu_list.append([indir + "/2018/output_ZH_HToGG_ZToAll_M120_TuneCP5_13TeV-powheg-pythia8.root"                        , "zh_120"         , 59.69, outdir + "/2018", "zh_had"])
    argu_list.append([indir + "/2018/output_ZH_HToGG_ZToAll_M130_TuneCP5_13TeV-powheg-pythia8.root"                        , "zh_130"         , 59.69, outdir + "/2018", "zh_had"])
...
parallel_process( vhmet_proc_func, argu_list )
